...
public class AdminInfoService {
    ...
    public List<AdminInfoVo> findByLevel(Integer level) {
        return adminInfoDao.findByLevel(level);
    }
    ...
    public PageInfo<AdminInfoVo> findPageLevel(String name, Integer level, Integer pageNum, Integer pageSize, HttpServletRequest request) {
        PageHelper.startPage(pageNum, pageSize);
        List<AdminInfoVo> all = adminInfoDao.findByNameLevel(name,level);
        return PageInfo.of(all);
    }
